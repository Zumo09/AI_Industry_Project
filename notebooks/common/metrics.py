...
def errors_curve(
    ...
    y_true = fill_tolerance(labels, tolerance).flatten()

    fp, _, thrs = _fp_fn_curve(y_true, y_score, pos_label=1)
...
def errors_curve_2(
    ...
    fps, tps, thresholds = _skm._ranking._binary_clf_curve(y_true, y_score, pos_label=1)
    # _, tps, _ = _skm._ranking._binary_clf_curve(1 - y_true, y_score, pos_label=0)
